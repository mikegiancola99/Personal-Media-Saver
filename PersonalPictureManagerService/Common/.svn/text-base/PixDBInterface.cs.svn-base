...
namespace PictureUploader
{
    public class PixDBInterface
    {
        public PixDBInterface()
        {
            ...
            //m_removePixQueueSql = "delete from PixQueue where Filename=";
        }
        ...
        public void Test()
        {
            ...
            SqlCeParameter param = cmd.Parameters.AddWithValue("@filename", "mikeg");
            string test = "Removing entry from Queue table : " + cmd.CommandText;
        ...
        {
            Logger log = new Logger("PixDBInterface::RemoveEntryFromPixQueue");
            bool added = false;
            ...
            try
            {
                //String tmp = m_removePixQueueSql + "'" + inFile + "'";
                //SqlCeCommand cmd = new SqlCeCommand(tmp, cn);
                SqlCeCommand cmd = new SqlCeCommand(m_removePixQueueSql, cn);
                SqlCeParameter param = cmd.Parameters.AddWithValue("@filename", inFile);
                
                //log.WriteMessage("Removing entry from Queue table : " + cmd.CommandText + " param name: " + param.ParameterName + " value: " + param.Value);
                cmd.ExecuteNonQuery();
                added = true;
            }
            catch (Exception  e )
